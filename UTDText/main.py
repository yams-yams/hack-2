...
domain = "catalog.utdallas.edu"
full_url = "https://catalog.utdallas.edu/2022/undergraduate/courses/"
...
def crawl(url):
    ...
    while queue:
        ...
        # print('text/' + local_domain + '/' + url[8:].replace("/", "_").replace("=", "_").replace("?", "_") + ".txt")
...
df = pd.read_csv('../app/processed/embeddings.csv', index_col=0)
print("start apply")
...
print(answer_question(df, question="How many credits do i need to graduate?", debug=False))
